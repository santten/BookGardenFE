        ...
        <div className="sticky top-0 bg-white">
            <div className="m-auto py-[12px] px-0 min-w-max max-w-[90vw] flex flex-row">
                ...
                <div className="ml-4 grow-[2] mr-4 basis-1/2 font-bold grid grid-cols-3 self-center text-center place-content-center">
                    <NavLink to="/" className="hover:text-primary-dark">Home</NavLink>
                    <NavLink to="/store" className="hover:text-primary-dark">Store</NavLink>
                    <NavLink to="/contacts" className="hover:text-primary-dark">Contacts</NavLink>
                </div>
