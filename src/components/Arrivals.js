    ...
    <section className="bg-white py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center">
          <h2 className="text-3xl text-gray-900 font-title">
          ...
          {books.map((book) => (
            ...
            >
              ...
              <div className="text-center">
                ...
                <p className="text-yellow-500 mt-1">Rating: {book.rating}</p>
                <div className="mt-4 flex justify-between items-center">
                  <button className="px-4 py-2 bg-black text-white rounded-lg flex items-center hover:bg-gray-800">
                    Order now
